...
export interface MockERC20 extends BaseContract {
  ...
  initialize: TypedContractMethod<[name_: string, symbol_: string, decimals_: BigNumberish], [void], 'nonpayable'>
  ...
  ): TypedContractMethod<[name_: string, symbol_: string, decimals_: BigNumberish], [void], 'nonpayable'>
