...
export interface MockERC721 extends BaseContract {
  ...
  approve: TypedContractMethod<[spender: AddressLike, id: BigNumberish], [void], 'payable'>

  balanceOf: TypedContractMethod<[owner: AddressLike], [bigint], 'view'>

  getApproved: TypedContractMethod<[id: BigNumberish], [string], 'view'>

  initialize: TypedContractMethod<[name_: string, symbol_: string], [void], 'nonpayable'>
  ...
  transferFrom: TypedContractMethod<[from: AddressLike, to: AddressLike, id: BigNumberish], [void], 'payable'>

  getFunction<T extends ContractMethod = ContractMethod>(key: string | FunctionFragment): T

  getFunction(
    nameOrSignature: 'approve'
  ): TypedContractMethod<[spender: AddressLike, id: BigNumberish], [void], 'payable'>
  getFunction(nameOrSignature: 'balanceOf'): TypedContractMethod<[owner: AddressLike], [bigint], 'view'>
  getFunction(nameOrSignature: 'getApproved'): TypedContractMethod<[id: BigNumberish], [string], 'view'>
  getFunction(
    nameOrSignature: 'initialize'
  ): TypedContractMethod<[name_: string, symbol_: string], [void], 'nonpayable'>
  getFunction(
  ...
  ): TypedContractMethod<[from: AddressLike, to: AddressLike, id: BigNumberish], [void], 'payable'>
  getFunction(
    nameOrSignature: 'safeTransferFrom(address,address,uint256,bytes)'
  ): TypedContractMethod<[from: AddressLike, to: AddressLike, id: BigNumberish, data: BytesLike], [void], 'payable'>
  getFunction(
