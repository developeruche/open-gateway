...
export namespace SlotFoundEvent {
  export type InputTuple = [who: AddressLike, fsig: BytesLike, keysHash: BytesLike, slot: BigNumberish]
  export type OutputTuple = [who: string, fsig: string, keysHash: string, slot: bigint]
...
export interface StdStorageSafe extends BaseContract {
  ...
  getEvent(
    key: 'SlotFound'
  ): TypedContractEvent<SlotFoundEvent.InputTuple, SlotFoundEvent.OutputTuple, SlotFoundEvent.OutputObject>
  getEvent(
