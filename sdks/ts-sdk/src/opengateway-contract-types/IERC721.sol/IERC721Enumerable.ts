...
export namespace ApprovalEvent {
  export type InputTuple = [_owner: AddressLike, _approved: AddressLike, _tokenId: BigNumberish]
  export type OutputTuple = [_owner: string, _approved: string, _tokenId: bigint]
...
export namespace ApprovalForAllEvent {
  export type InputTuple = [_owner: AddressLike, _operator: AddressLike, _approved: boolean]
  export type OutputTuple = [_owner: string, _operator: string, _approved: boolean]
  export interface OutputObject {
    _owner: string
    _operator: string
    _approved: boolean
...
export namespace TransferEvent {
  export type InputTuple = [_from: AddressLike, _to: AddressLike, _tokenId: BigNumberish]
...
export interface IERC721Enumerable extends BaseContract {
  ...
  approve: TypedContractMethod<[_approved: AddressLike, _tokenId: BigNumberish], [void], 'payable'>
  ...
  isApprovedForAll: TypedContractMethod<[_owner: AddressLike, _operator: AddressLike], [boolean], 'view'>
  ...
  'safeTransferFrom(address,address,uint256,bytes)': TypedContractMethod<
    [_from: AddressLike, _to: AddressLike, _tokenId: BigNumberish, data: BytesLike],
    [void],
    'payable'
  >

  setApprovalForAll: TypedContractMethod<[_operator: AddressLike, _approved: boolean], [void], 'nonpayable'>

  supportsInterface: TypedContractMethod<[interfaceID: BytesLike], [boolean], 'view'>

  tokenByIndex: TypedContractMethod<[_index: BigNumberish], [bigint], 'view'>

  tokenOfOwnerByIndex: TypedContractMethod<[_owner: AddressLike, _index: BigNumberish], [bigint], 'view'>

  totalSupply: TypedContractMethod<[], [bigint], 'view'>

  transferFrom: TypedContractMethod<[_from: AddressLike, _to: AddressLike, _tokenId: BigNumberish], [void], 'payable'>

  getFunction<T extends ContractMethod = ContractMethod>(key: string | FunctionFragment): T

  getFunction(
    nameOrSignature: 'approve'
  ): TypedContractMethod<[_approved: AddressLike, _tokenId: BigNumberish], [void], 'payable'>
  ...
  ): TypedContractMethod<[_owner: AddressLike, _operator: AddressLike], [boolean], 'view'>
  getFunction(nameOrSignature: 'ownerOf'): TypedContractMethod<[_tokenId: BigNumberish], [string], 'view'>
  getFunction(
    nameOrSignature: 'safeTransferFrom(address,address,uint256)'
  ): TypedContractMethod<[_from: AddressLike, _to: AddressLike, _tokenId: BigNumberish], [void], 'payable'>
  getFunction(
  ...
  ): TypedContractMethod<[_operator: AddressLike, _approved: boolean], [void], 'nonpayable'>
  getFunction(nameOrSignature: 'supportsInterface'): TypedContractMethod<[interfaceID: BytesLike], [boolean], 'view'>
  getFunction(nameOrSignature: 'tokenByIndex'): TypedContractMethod<[_index: BigNumberish], [bigint], 'view'>
  getFunction(
    nameOrSignature: 'tokenOfOwnerByIndex'
  ): TypedContractMethod<[_owner: AddressLike, _index: BigNumberish], [bigint], 'view'>
